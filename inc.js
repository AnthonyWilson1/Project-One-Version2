function income(param) {
    ...
    var fips = {
        ...
        function createChart3(label, value, value2) {
        var ctx = $("#myChartPop3");
        var myChart = new Chart(ctx, {
            ...
            data: {
                labels: label,
                datasets: [{
                    label: '2016 % of Mean Income',
                    data: value,
                    backgroundColor: colors,
                    borderColor: borders,
                    borderWidth: .5
                },{
                    label: '2015 % of Mean Income',
                    data: value2,
        ...
        $.ajax({
            ...
            setTimeout(function(){
                insertChart3();
                createChart3(labelsOrigin,datas, datas2015);
              },3000);
            
        })   
    
        function insertChart3() {
        var canvas = $('<canvas>')
        canvas.attr('id', 'myChartPop3')
